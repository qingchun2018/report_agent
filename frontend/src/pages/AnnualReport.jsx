  ...
  return (
    <div className="max-w-7xl space-y-6">
      ...
      {kpi && (() => {
        ...
        const isUp = diff >= 0;
        return (
          <div className="relative overflow-hidden bg-[#161b22] border border-[#30363d] rounded-3xl p-8 shadow-lg max-w-lg">
            ...
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className={`text-xl font-bold ${isUp ? 'text-[#3fb950]' : 'text-[#f85149]'}`}>
